...
extension UIView {
    ...
    */
    ...
    class func hr_toastThemeColor() -> UIColor {
        ...
        if color == nil {
            color = UIColor(red: 117/255.0, green: 127/255.0, blue: 126/255.0, alpha: 0.7)
    ...
    private func showToast(toast toast: UIView, duration: Double, position: AnyObject) {
        ...
        let timer = NSTimer.scheduledTimerWithTimeInterval(duration, target: self, selector: #selector(self.toastTimerDidFinish(_:)), userInfo: toast, repeats: false)
    ...
    private func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        if (!msg.isEmpty){
            ...
            activityMessageLabel.font = (msg.characters.count<=10) ? UIFont.init(name:UIView.hr_toastFontName(), size: 16) : UIFont.init(name:UIView.hr_toastFontName(), size: 13)
    ...
    */
    ...
    func handleToastTapped(recognizer: UITapGestureRecognizer) {
        if let timer = objc_getAssociatedObject(self, &HRToastTimer) {
            timer.invalidate()
        }
    ...
    private func viewForMessage(msg: String?, title: String?, image: UIImage?) -> UIView? {
        ...
        if title != nil {
            ...
            titleLabel!.font = UIFont.init(name: UIView.hr_toastFontName(), size: HRToastFontSize)
        ...
        if msg != nil {
            ...
            msgLabel!.font = UIFont.init(name: UIView.hr_toastFontName(), size: HRToastFontSize)
...
extension String {
    ...
    func stringHeightWithFontSize(fontSize: CGFloat,width: CGFloat) -> CGFloat {
        let font = UIFont.init(name: UIView.hr_toastFontName(), size: HRToastFontSize)
