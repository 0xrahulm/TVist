...
class MyAccountItems: NSObject {
    ...
    init(id: String?,firstName:String?,lastName:String?,email:String?,gender:String?,profilePicture:String?,followers:NSNumber?,following:NSNumber?,movies_count :  NSNumber?,books_count:NSNumber?,tvShows_count : NSNumber?) {
