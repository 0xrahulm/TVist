...
- (void)initialiseControl {
    ...
    _handleDiameter = 25.0;
    _selectedHandleDiameterMultiplier = 1.3;
    ...
    self.sliderLine.backgroundColor = [UIColor styleGuideInputColor].CGColor;
    self.sliderLine.borderColor = [UIColor styleGuideInputColor].CGColor;
